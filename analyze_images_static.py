...
def main():    
    ...
    class ExtractedInformation(BaseModel):    
        wellsNames: list[str]  
        tableFound: str  
        costCodeTable: list[costCodeRow]
